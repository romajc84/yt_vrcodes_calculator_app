...
import 'package:yt_vrcodes_calculator_app/widgets/value_button.dart';

class ButtonLayout extends StatelessWidget {
  final ExpressionController expController = Get.find();
        ...
        child: Row(
          ...
          children: [
            ...
            GestureDetector(
              ...
              onLongPress: () {
                // Adding the rest of the functionality
                expController.restExp();
              },
              child: Container(
                height: Get.height * 0.15,
                width: Get.width * 0.2,
